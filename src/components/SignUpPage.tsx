...
interface CountryOption extends SimpleCountry {
  flag: string;
}
  ...
  useEffect(() => {
    const fetchCountries = async () => {
      try {
        ...
        const countryOptions: CountryOption[] = countryData.map((c: any) => ({
          code: c.code,
          name: c.name,
          flag: c.flag_emoji || '🌍',
        }));
          ...
          <div className="w-full max-w-md">
            <div className="mb-10 flex flex-col items-center animate-fade-in">
              <div className="flex items-end">
                <span className="text-4xl font-bold text-ash-teal">AfroScholar</span>
                <span className="ml-2 text-xl font-medium text-ash-dark">Hub</span>
              </div>
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm animate-fade-in">
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <Link to="/login" className="font-medium text-ash-teal hover:text-ash-teal/80 transition-colors duration-200">
                    Sign in
                  </Link>
                </p>
              </div>
        ...
        <div className="hidden bg-gradient-to-br from-ash-teal to-ash-dark sm:block sm:w-1/2">
          <div className="flex h-full flex-col items-center justify-center px-8 text-white">
            <div className="mb-8 max-w-md animate-fade-in">
              <h1 className="mb-6 text-4xl font-bold">Join Our Mission</h1>
              <p className="mb-8 text-lg text-white/80">
                Become an ambassador and help connect schools across Africa with educational opportunities.
              </p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
          <div className="mx-4 w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
            <div className="mb-4 flex items-center">
              <GlobeIcon size={24} className="mr-2 text-ash-teal" />
              <h3 className="text-lg font-semibold text-gray-900">Select Your Country</h3>
            </div>
            <p className="mb-4 text-sm text-gray-600">
              Choose the country where you'll be working as an ambassador.
            </p>
            {countriesLoading ? (
